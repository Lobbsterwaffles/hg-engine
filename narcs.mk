...
OVERWORLDS_NEWNPCS_SRCS := $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/newnpcs/*.png) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/newnpcs/*.json) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/newnpcs/*.pal)
OVERWORLDS_NEWNPCS_OBJS := $(patsubst $(OVERWORLDS_DEPENDENCIES_DIR)/newnpcs/%.png,$(OVERWORLDS_DIR)/2_%.btx0,$(OVERWORLDS_NEWNPCS_SRCS))

# add your own overworld sources here
ALL_OVERWORLDS_SRCS := $(OVERWORLDS_SRCS) $(OVERWORLDS_NEWNPCS_SRCS)
ALL_OVERWORLDS_OBJS := $(OVERWORLDS_OBJS) $(OVERWORLDS_NEWNPCS_OBJS)


$(OVERWORLDS_DIR)/1_%.btx0:$(OVERWORLDS_DEPENDENCIES_DIR)/%.png $(OVERWORLDS_DEPENDENCIES_DIR)/%.json
	$(BTX) $< $@
...
$(OVERWORLDS_DIR)/2_%.btx0:$(OVERWORLDS_DEPENDENCIES_DIR)/newnpcs/%.png $(OVERWORLDS_DEPENDENCIES_DIR)/newnpcs/%.json
	$(BTX) $< $@	
