...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_IRIS] = {0xFFFF, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_LORELEI] = {0XFFFF, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_STEVEN] = {0XFFFF, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_CYNTHIA] = {0xFFFF, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_WALLACE] = {0xFFFF, SEQ_GS_VS_CHAMP},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_CHAMPION_IRIS, ANIM_MUSIC_COMBO_IRIS*4},
    {TRAINERCLASS_KAHUNA_LORELEI, ANIM_MUSIC_COMBO_LORELEI*4},
    {TRAINERCLASS_PKMN_TRAINER_STEVEN, ANIM_MUSIC_COMBO_STEVEN*4},
    {TRAINERCLASS_CHAMPION_CYNTHIA, ANIM_MUSIC_COMBO_CYNTHIA*4},
    {TRAINERCLASS_CHAMPION_WALLACE, ANIM_MUSIC_COMBO_WALLACE*4},
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_CHAMPION_IRIS, .music1 = SEQ_GS_VS_CHAMP, .music2 = SEQ_GS_VS_CHAMP},
    {.class = TRAINERCLASS_KAHUNA_LORELEI, .music1 = SEQ_GS_VS_CHAMP, .music2 = SEQ_GS_VS_CHAMP},
    {.class = TRAINERCLASS_PKMN_TRAINER_STEVEN, .music1 = SEQ_GS_VS_CHAMP, .music2 = SEQ_GS_VS_CHAMP},
    {.class = TRAINERCLASS_CHAMPION_CYNTHIA, .music1 = SEQ_GS_VS_CHAMP, .music2 = SEQ_GS_VS_CHAMP},
    {.class = TRAINERCLASS_CHAMPION_WALLACE, .music1 = SEQ_GS_VS_CHAMP, .music2 = SEQ_GS_VS_CHAMP},
};
