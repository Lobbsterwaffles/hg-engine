...
u16 sBlackthornAndBattleFrontierMart[] = {
    ITEM_SHINY_STONE, ITEM_DUSK_STONE, ITEM_DAWN_STONE, ITEM_LINKING_CORD, ITEM_KINGS_ROCK, ITEM_DEEP_SEA_SCALE, ITEM_DEEP_SEA_TOOTH, ITEM_UP_GRADE,
    ...
    ITEM_GALARICA_WREATH, ITEM_SWEET_APPLE, ITEM_TART_APPLE, ITEM_SYRUPY_APPLE, ITEM_UNREMARKABLE_TEACUP, ITEM_MASTERPIECE_TEACUP, ITEM_ROTOM_CATALOG, 0xFFFF
};
...
u16 sCeladonDepartment3F[] = {
    ITEM_TM059, ITEM_TM079, ITEM_TM106, ITEM_TM112, ITEM_TM115,
