...
class EvolutionMethod(enum.IntEnum):
    ...
    SPIN_CLOCKWISE_LESS_THAN_5_SECONDS_DAY = 38, EvoParam.OTHER
    SPIN_COUNTERCLOCKWISE_LESS_THAN_5_SECONDS_DAY = 39, EvoParam.OTHER
    SPIN_CLOCKWISE_LESS_THAN_5_SECONDS_NIGHT = 40, EvoParam.OTHER
    SPIN_COUNTERCLOCKWISE_MORE_THAN_5_SECONDS_NIGHT = 41, EvoParam.OTHER
    SPIN_CLOCKWISE_MORE_THAN_5_SECONDS_NIGHT = 42, EvoParam.OTHER
    SPIN_COUNTERCLOCKWISE_LESS_THAN_5_SECONDS_NIGHT = 43, EvoParam.OTHER
    SPIN_COUNTERCLOCKWISE_MORE_THAN_5_SECONDS_DAY = 44, EvoParam.OTHER
    SPIN_CLOCKWISE_MORE_THAN_5_SECONDS_DAY = 45, EvoParam.OTHER
    SPIN_MORE_THAN_10_SECONDS_EVENING = 46, EvoParam.OTHER
    FORM_ARGUMENT = 47, EvoParam.OTHER
    LETS_GO = 48, EvoParam.OTHER
    DUMMY = 49, EvoParam.OTHER
